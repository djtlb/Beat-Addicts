async function generateDrumAndBass() {
  ...
  console.log(`   🎵 Title: Experimental DnB #${trackId.slice(0, 6).toUpperCase()}`);
  console.log('   🎧 Genre: Drum & Bass');
  console.log('   🎛️  BPM: 170-180');
  console.log('   🎼 Structure: Intro → Build → Drop → Breakdown → Outro');
  console.log('   🎚️  Features: Rolling basslines, chopped breaks, atmospheric pads');
  console.log('');
...
// Run the demo
generateDrumAndBass().catch(console.error);
